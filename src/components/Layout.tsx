...
export function PhoneShell({
  ...
  return (
    <div className="min-h-screen w-full bg-slate-200 bg-pattern flex items-center justify-center md:p-6">
      <div className="w-full md:w-[420px] md:h-[860px] h-screen bg-white md:rounded-[42px] md:shadow-2xl md:border-[10px] md:border-slate-900 relative overflow-hidden flex flex-col">
        ...
        {!hideNav && (
          <nav className="shrink-0 bg-white border-t border-slate-200 px-1 pb-3 pt-2 grid grid-cols-5 gap-0.5">
